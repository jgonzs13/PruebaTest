...
public class AccountTest {
	...
	public void testAccountAccount() {
		...
		assertSame(this.john, anotherJohnAccount.getOwner());
	...
	public void testAccountPersonInt() {
		...
		assertSame(this.john, this.johnAccount.getOwner());
	...
	public void testWithdraw() {
		...
		assertEquals(700, johnAccount.getBalance());
	}
	...
	public void testNotBasicTypeParameterOwner() {
		...
		assertEquals(charlesAccount.toString(), "Account: Charlie - Balance: 3000");
	}
	...
	public void testNotBasicTypeReturnValue() {
		...
		assertEquals(this.johnAccount.toString(), "Account: Johnie - Balance: 1000");		
	}
